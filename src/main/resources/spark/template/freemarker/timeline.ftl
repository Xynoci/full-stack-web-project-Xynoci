    ...
    <div class="wrapper">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs">Xynoci</span>
                            </a>
                            <ul class="dropdown-menu">
                        ...
                        <li class="dropdown login-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="display:none">Sign In</a>
                        </li>
        ...
        <aside class="main-sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="./homepage.html"><i class="fa fa-user"></i> <span>Profile</span> <i class="fa fa-angle-left pull-right"></i></a>
            ...
            <div class="main-content clearfix">
                            ...
                            <div class="box-body">
                                <ul class="products-list product-list-in-box">
                                    ...
                                    <li class="item">
                                        ...
                                        <div class="product-info">
                                            <a href="javascript#" class="product-title">Cloud Computing<span class="label label-danger pull-right">56</span></a>
                                            <span class="product-description">
                ...
                <section class="posts-list">
                    ...
                    <div class="box box-widget">
                        ...
                        <div class="box-body">
                            <!-- post text -->
                            <p>Please review the Assignment Description in the syllabus here and answer the following questions proposed in the rubric. What should I do with that?!😱
                            </p>
                            <!-- Attachment -->
                            <div class="attachment-block clearfix">
                                <img class="attachment-img" src="./dist/img/photo1.png" alt="Attachment Image">
                                <div class="attachment-pushed">
                                    <h4 class="attachment-heading"><a href="http://www.lipsum.com/">Assignment 1.3 Presentation tier  </a></h4>
                                    <div class="attachment-text">
                                        ***Do not use .ftl pages for this phase of the assignment*** At least 5 separate Web Pages in HTML5 (.html, .htm) or XHTML (.xhtml) format ... <a href="#">more</a>
                                    </div>
                                    <!-- /.attachment-text -->
                                </div>
                                <!-- /.attachment-pushed -->
                        ...
                        <div class="box-footer">
                            <form action="#" method="post">
                                <img class="img-responsive img-circle img-sm" src="./dist/img/user9-160x160.jpg" alt="Alt Text">
